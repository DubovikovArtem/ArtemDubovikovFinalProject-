...
public class ProfilePage {
    private final SelenideElement nameProfilePage = $x("/html/body/app-root/div/app-profile/div/h1");
    private final SelenideElement closeProfileButton = $x("/html/body/app-root/div/app-profile/div/div[1]/button[2]");
    ...
    private final SelenideElement inputText = $("body > app-root > div > app-profile > div > div.row > app-add-job > div > h2");
    ...
    //body > app-root > div > app-profile > div > div.row > app-my-jobs > div > mat-card > mat-card-header > div > mat-card-title
    private final SelenideElement deleteJob = $("mat-card-actions > button");
    ...
    public void deleteJob(String jobName) {
        jobTitle.find(Condition.text(jobName));
        deleteJob.click();
